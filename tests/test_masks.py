...
def test_len_mask_card_number(value: str, expected: int) -> None:
...
@pytest.mark.parametrize(
    "value, expected",
    [
        ("73654108430135874305", 6),
        ("64686473678894779589", 6),
        ("35383033474447895560", 6),
    ],
)
def test_len_get_mask_account(value: str, expected: int) -> None:
